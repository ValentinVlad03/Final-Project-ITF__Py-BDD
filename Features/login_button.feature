...
#    Given I am on the DiamondSystem homepage and I want to authenticate with an invalid password
...
#      | asdasdsa  | Eroare: parola pe care ai introdus-o pentru adresa de email "<email>" este incorectă. Ai uitat parola? |
#
